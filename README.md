...
This project is licensed under the MIT License - see the [LICENSE.md](https://github.com/TomaszKaminski-netizen/german-learning/blob/master/LICENSE) file for details.
