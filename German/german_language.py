...
NOUNS_DICT = {
    ...
    "das Geschirr / die Geschirre": "the dishes (tableware)",
    ...
    "das Papiertuch / die Papiertücher": "the paper towel",
    "das Toilettenpapier / die Toilettenpapiere": "the toilet paper",
    "die Waschmaschine / die Waschmaschinen": "the washing machine",
    "die Spülmaschine / die Spülmaschinen": "the dishwasher",
    "der Wäschetrockner / die Wäschetrockner": "the clothes dryer",
    ...
    "das Möbel / die Möbel": "the furniture",
    ...
    "die Kleidung / die Kleidungen": "the clothes",
    ...
    "das Hühnerfleisch": "the chicken",
    "das Putenfleisch": "the turkey",
    "das Lammfleisch": "the lamb",
    "der Fisch": "the fish",
...
TIPS = (
    ...
    keinen Spaß gemacht? Das schon, aber das Geld war zu wenig' -> 'Did you not enjoy your old job?
    I did, but the money was too little'.""",
    ...
    good thought, but it is not a new one -> Das ist zwar ein guter, aber kein neuer Gedanke).
    Secondly, zwar combined with und announces clarification of the previous statement (e.g. The
    family is travelling south on vacation, specifically to Italy -> Die Familie reist im Urlaub in
    den Süden, und zwar nach Italien). Here zwar is best thought of as 'namely' or a dash (—).""",
    ...
    """The word egal denotes indifference or irrelevance. Taken literally, it means 'all the same',
